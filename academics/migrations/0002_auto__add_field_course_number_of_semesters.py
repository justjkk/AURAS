...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.number_of_semesters'
        db.add_column('academics_course', 'number_of_semesters', self.gf('django.db.models.fields.IntegerField')(default=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.number_of_semesters'
        db.delete_column('academics_course', 'number_of_semesters')
