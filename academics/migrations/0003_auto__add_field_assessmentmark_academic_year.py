...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssessmentMark.academic_year'
        db.add_column('academics_assessmentmark', 'academic_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AssessmentMark.academic_year'
        db.delete_column('academics_assessmentmark', 'academic_year')
